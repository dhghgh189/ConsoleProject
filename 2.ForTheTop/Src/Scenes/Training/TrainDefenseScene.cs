...
{
    public class TrainDefenseScene : BaseScene, IActable
    {
        int _actionPosX = 16;
        int _actionPosY = 16;
        ...
        {
            _trainType = Define.ETrainType.Defense;
        ...
        public override void Enter()
        {
            ...
            _beforeDefense = Game.Player.Stat.Defense;
        ...
        public override void Render()
        {
            ...
            Util.PrintLine("[ TrainDefenseScene ]\n", _textColor);
        ...
        void PrintResult()
        {
            ...
            Util.Print($"{Game.Player.Stat.Defense}", _textColor);
            Util.PrintLine(")");
            Thread.Sleep(2500);
        }
        #endregion
