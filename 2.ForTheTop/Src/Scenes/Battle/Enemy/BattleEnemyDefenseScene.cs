...
{
    public class BattleEnemyDefenseScene : BaseScene
    {
        int _playerPosX = 3;
        int _playerPosY = 12;
        ...
        public BattleEnemyDefenseScene() : base(Define.EScene.BattleEnemyDefense)
        {
            _actionType = Define.ESubAction.BattleEnemyDefense;
        ...
        void PrintInfoMsg()
        {
            ...
            Warrior defender = Game.Actor.CurrentEnemy;
